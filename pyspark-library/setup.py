...
setup(
    ...
    #
    # 1. Create the function you want to run on the CLI in src/spark-pyutil/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/spark-pyutil (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # spark-pyutil = spark-pyutil.cli:main
    # """,
    #
